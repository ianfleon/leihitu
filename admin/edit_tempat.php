...
if ( isset($_POST["btnSimpan"]) ) {
  ...
  // cek
  if( empty($_POST["kategori"]) || empty($_POST["nama"]) || empty($_POST["deskripsi"]) || empty($_POST["map_link"])) {
    $error = "Ada data yang tidak diinput. Periksa Lagi!";
  } else {
    // Kirim Data
    if ( editTempat($_POST) > 0) {
      print "<script>alert('Data berhasil diubah!')</script>";
      print("<script>window.location.href = 'data_tempat.php'</script>");
    } else {
      print "<script>alert('Data gagal diubah! / Data baru sama dengan yang lama!')</script>";
      print("<script>window.location.href = 'data_tempat.php'</script>");
    }
  }
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form class="form-horizontal style-form" action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        <img src="../img/<?= $rows[0]["gambar_tempat"]; ?>" alt=""/>
                      </div>
                ...
                <input type="hidden" name="id" value="<?= $rows[0]["id_tempat"]; ?>">
                <input type="hidden" name="gambar_lama" value="<?= $rows[0]["gambar_tempat"]; ?>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nama Tempat</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" value="<?= $rows[0]["nama_tempat"]; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control ckeditor" id="ckeditor" name="deskripsi">
                      <?= $rows[0]["deskripsi_tempat"]; ?>
                    </textarea>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="map_link" value='<?= $rows[0]["link_map"]; ?>'>
